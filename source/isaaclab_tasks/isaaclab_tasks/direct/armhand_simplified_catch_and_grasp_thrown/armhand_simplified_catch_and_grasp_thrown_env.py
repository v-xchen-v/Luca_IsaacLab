...
@configclass
class ArmHandSimplifiedCatchAndGraspThrownEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 2
...
class ArmHandSimplifiedCatchAndGraspThrownEnv(DirectRLEnv):
    cfg: ArmHandSimplifiedCatchAndGraspThrownEnvCfg

    def __init__(self, cfg: ArmHandSimplifiedCatchAndGraspThrownEnvCfg, render_mode: str | None = None, **kwargs):
